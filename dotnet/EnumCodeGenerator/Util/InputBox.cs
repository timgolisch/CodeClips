...
#region Windows Form code
    private static void InitializeComponent()
    {
        ...
        lblPrompt.Size = new Size(302, 15);
        ...
        btnOK.Location = new Point(326, 10);
        btnOK.Name = "btnOK";
        ...
        btnCancel.Location = new Point(326, 35);
        ...
        // cboInput
        // 
        txtInput.Location = new Point(13, 35);
        ...
        frmInputDialog.BackColor = System.Drawing.Color.WhiteSmoke;
...
#region Private function, InputBox Form move and change size
    static private void LoadForm()
    {
        ...
        OutputResponse.ReturnString = null;
...
static private void btnOK_Click(object sender, System.EventArgs e)
{
    ...
    OutputResponse.ReturnString = txtInput.Text;
...
static private void btnCancel_Click(object sender, System.EventArgs e)
{
    ...
    OutputResponse.ReturnString = null; //Clean output response
    frmInputDialog.Dispose();
}
#endregion
